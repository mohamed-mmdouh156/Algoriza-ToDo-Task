  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AppCubit , AppStates>(
      ...
      builder: (context ,state) {
        List<Map> favoriteTasks = AppCubit.get(context).favoriteTasks;
        return Padding(
                ...
                children: [
                  Expanded(
                    child: ListView.separated(
                      ...
                      itemBuilder: (context , index) => ToDoItem(itemColor: favoriteTasks[index]['color'] , itemText: favoriteTasks[index]['title'], id: favoriteTasks[index]['id'] , isDone: favoriteTasks[index]['completed'] == 1 ?true : false,),
